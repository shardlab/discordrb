...
module Discordrb::Events
  ...
  class InteractionCreateEvent < Event
    ...
    def update_message(content: nil, tts: nil, embeds: nil, allowed_mentions: nil, flags: 0, ephemeral: nil, wait: false, components: nil, poll: nil, &block)
    ...
    def edit_response(content: nil, embeds: nil, allowed_mentions: nil, components: nil, poll: nil, &block)
      @interaction.edit_response(content: content, embeds: embeds, allowed_mentions: allowed_mentions, components: components, poll: poll, &block)
    end
    ...
    def send_message(content: nil, embeds: nil, tts: false, allowed_mentions: nil, flags: 0, ephemeral: nil, components: nil, poll: nil, &block)
      @interaction.send_message(content: content, embeds: embeds, tts: tts, allowed_mentions: allowed_mentions, flags: flags, ephemeral: ephemeral, components: components, poll: poll, &block)
    end

    # (see Interaction#edit_message)
    def edit_message(message, content: nil, embeds: nil, allowed_mentions: nil, poll: nil, &block)
      @interaction.edit_message(message, content: content, embeds: embeds, allowed_mentions: allowed_mentions, poll: poll, &block)
    end
