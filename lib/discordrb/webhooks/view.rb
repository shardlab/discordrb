...
class Discordrb::Webhooks::View
  ...
  class SectionBuilder
    ...
    # @param id [Integer, nil] The 32-bit ID of this text display component.
    # @param text [String, nil] The text content of this text display component.
  ...
  class ContainerBuilder
    ...
    # @!visibility private
    def initialize(id = nil, colour = nil, spoiler = nil)
      @id = id
      @colour = colour
      @spoiler = spoiler
      @components = []
    ...
    # @param id [Integer, nil] The 32-bit ID of this media gallery component.
    # @yieldparam builder [MediaGalleryBuilder] The media gallery builder is yielded to allow for the modification of attributes.
    def media_gallery(id: nil)
      builder = MediaGalleryBuilder.new(id)
    ...
    # @param id [Integer, nil] The 32-bit ID of this seperator component.
    # @param divider [true, false] Whether the seperator should appear as a visual divider.
    # @param spacing [Integer, Symbol, nil] The size of the seperator's padding. See {SEPERATOR_SIZES}.
    # @yieldparam builder [SectionBuilder] The section builder is yielded to allow for the modification of attributes.
    ...
    # @param id [Integer, nil] The 32-bit ID of this file component.
    # @param url [String, nil] The `attachment://<filename>` reference of this file component.
    # @param spoiler [true, false] Whether this file component should have a spoiler label.
    ...
    # @param id [Integer, nil] The 32-bit ID of this action row component.
  ...
  # @param id [Integer, nil] The 32-bit ID of this container component.
  # @param colour [String, #to_i, Array<Integer>, nil] The accent colour of this container component.
  # @param spoiler [true, false] WhetWhether this container component should have a spoiler label.
  # @yieldparam builder [ContainerBuilder] The container builder is yielded to allow for for modification of attributes.
  def container(id: nil, colour: nil, color: nil, spoiler: false)
    builder = ContainerBuilder.new(id, colour || color, spoiler)
