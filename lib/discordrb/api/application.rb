...
module Discordrb::API::Application
  ...
  def create_global_command(token, application_id, name, description, options = [], default_permission = nil)
    Discordrb::API.request(
      :applications_aid_commands,
      nil,
      :post,
      "#{Discordrb::API.api_base}/applications/#{application_id}/commands",
      { name: name, description: description, options: options, default_permission: default_permission }.to_json,
      Authorization: token,
      content_type: :json
    )
  end
  ...
  def edit_global_command(token, application_id, command_id, name = nil, description = nil, options = nil, default_permission = nil)
    Discordrb::API.request(
      :applications_aid_commands_cid,
      nil,
      :patch,
      "#{Discordrb::API.api_base}/applications/#{application_id}/commands/#{command_id}",
      { name: name, description: description, options: options, default_permission: default_permission }.compact.to_json,
      Authorization: token,
      content_type: :json
    )
  end
  ...
  def create_guild_command(token, application_id, guild_id, name, description, options = nil, default_permission = nil)
    Discordrb::API.request(
      :applications_aid_guilds_gid_commands,
      guild_id,
      :post,
  ...
  def edit_guild_command(token, application_id, guild_id, command_id, name = nil, description = nil, options = nil, default_permission = nil)
    Discordrb::API.request(
      :applications_aid_guilds_gid_commands_cid,
      guild_id,
      :patch,
