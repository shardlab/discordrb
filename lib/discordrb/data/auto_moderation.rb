...
module Discordrb
  ...
  class AutoModRule
    ...
    def modify(
      ...
      trigger_kw = mention_raid_protection != :undef || exempt_keywords != :undef

      if trigger_kw || regex_patterns != :undef || keyword_filter != :undef || mention_limit != :undef || keyword_presets != :undef
    ...
    class Action
      ...
      # @return [Integer] the duration (in seconds) for which the user will be timed-out for.
