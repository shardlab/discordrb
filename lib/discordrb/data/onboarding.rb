...
module Discordrb
  ...
  class Onboarding
    ...
    # @param reason [String, nil] The reason to show in the server's audit log for creating the onboarding prompt.
    ...
    # @param reason [String, nil] The reason to show in the server's audit log for modifying the onboarding.
    # @return [nil]
    ...
    class Prompt
      ...
      # @return [nil]
      def create_option(title:, description: nil, emoji: nil, roles: [], channels: [], reason: nil)
        data = {
          title: title,
