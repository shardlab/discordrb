...
module Discordrb
  ...
  module UserAttributes
    ...
    def avatar_url(format = nil)
      unless @avatar_id
        return API::CDN.default_avatar(@discriminator, legacy: true) if @discriminator && @discriminator != '0'

        return API::CDN.default_avatar(@id)
      end

      API::CDN.avatar_url(@id, @avatar_id, format)
    end
