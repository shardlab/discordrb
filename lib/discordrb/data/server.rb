...
module Discordrb
  ...
  class Server
    ...
    def create_channel(name, type = 0, topic: nil, bitrate: nil, user_limit: nil, permission_overwrites: nil, parent: nil, nsfw: false, rate_limit_per_user: nil, position: nil, reason: nil)
      ...
      raise ArgumentError, 'Channel type must be either 0 (text), 2 (voice), 4 (category), 5 (news), 13 (voice stage), 15 (forum), or 6 (store)!' unless [0, 2, 4, 5, 6, 13, 15].include?(type)
