...
module Discordrb
  ...
  class Server
    ...
    def create_scheduled_event(name:, starts_at:, entity_type:, privacy_level: 2, ends_at: nil, channel: nil, location: nil, description: nil, cover: nil, recurrence_rule: nil, reason: nil)
      yield((builder = ScheduledEvent::RecurrenceRule::Builder.new)) if block_given?

      options = {
        name: name,
        privacy_level: privacy_level,
        scheduled_start_time: starts_at&.iso8601,
        ...
        scheduled_end_time: ends_at&.iso8601,
