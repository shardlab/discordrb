...
module Discordrb
  ...
  class AuditLogs
    ...
    CREATE_ACTIONS = %i[
      ...
      invite_create webhook_create emoji_create integration_create sticker_create
    ].freeze
    ...
    DELETE_ACTIONS = %i[
      ...
      emoji_delete message_delete message_bulk_delete integration_delete sticker_delete
    ].freeze
    ...
    class Entry
      ...
      def process_target(id, type)
        ...
        when :sticker then @server.sticker[id]
