...
module Discordrb
  ...
  class Bot
    ...
    #     end
    #   end
    def register_application_command(name, description, server_id: nil, default_permission: nil, type: :chat_input, default_member_permissions: nil, contexts: nil, name_localizations: nil, description_localizations: nil)
      ...
      resp = if server_id
               ...
               API::Application.create_global_command(@token, profile.id, name, description, builder.to_a, default_permission, type, default_member_permissions, contexts, name_localizations, description_localizations)
             end
