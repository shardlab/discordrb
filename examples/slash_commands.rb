...
bot = Discordrb::Bot.new(token: ENV['SLASH_COMMAND_BOT_TOKEN'], intents: [:guild_messages])
...
bot.register_application_command(:example, 'Example commands', guild_id: ENV['SLASH_COMMAND_BOT_GUILD_ID']) do |cmd|
...
bot.register_application_command(:spongecase, 'Are you mocking me?', guild_id: ENV['SLASH_COMMAND_BOT_GUILD_ID']) do |cmd|
